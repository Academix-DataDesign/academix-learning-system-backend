...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src={{ asset('assets/logo.png') }} alt="AdminLTELogo" height="360"
                width="auto">
        </div>
                    ...
                    <div class="navbar-search-block">
                        <form action="{{ route('user.search') }}" method="GET">
                            <div class="input-group input-group-sm">
                                <input value="dwd" name="query" type="text"
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href={{ route('web.courses.index') }}
                                        class="nav-link {{ request()->is('admin/dashboard/courses') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Courses</p>
                                ...
                                <li class="nav-item">
                                    <a href={{ route('web.types.index') }}
                                        class="nav-link {{ request()->is('admin/dashboard/types') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Types</p>
                                ...
                                <li class="nav-item">
                                    <a href={{ route('web.languages.index') }}
                                        class="nav-link {{ request()->is('admin/dashboard/languages') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Languages</p>
                                ...
                                <li class="nav-item">
                                    <a href={{ route('web.currencies.index') }}
                                        class="nav-link {{ request()->is('admin/dashboard/currencies') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Currencies</p>
                                ...
                                <li class="nav-item">
                                    <a href={{ route('web.releases.index') }}
                                        class="nav-link {{ request()->is('admin/dashboard/releases') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Releases</p>
